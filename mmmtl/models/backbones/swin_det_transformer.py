...
class SwinTransformerDet(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(SwinTransformerDet, self).__init__(init_cfg=init_cfg)
        ...
        # print('pretrained: ', pretrain_img_size, patch_size)
        # assert False

    def train(self, mode=True):
        """Convert the model into training mode while keep layers freezed."""
        super(SwinTransformerDet, self).train(mode)
        self._freeze_stages()
    ...
    def forward(self, x):
        # print('x.shape: ', x.shape) # 2, 3, 800, 1216 can be different
        x, hw_shape = self.patch_embed(x)

        # print('after patch shape: ', x.shape)
