...
from mmmtl.core import intersect_and_union
from mmmtl.datasets.pipelines.seg import LoadAnnotationsSeg, LoadImageFromFileSeg
from .builder import SEG_DATASETS, SEG_PIPELINES
from .custom import CustomDataset


@SEG_PIPELINES.register_module()
class LoadImageNetSImageFromFile(LoadImageFromFileSeg):
...
@SEG_PIPELINES.register_module()
class LoadImageNetSAnnotations(LoadAnnotationsSeg):
