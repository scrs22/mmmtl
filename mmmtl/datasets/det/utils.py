...
from .builder import DET_PIPELINES
from ..pipelines.det import (LoadAnnotationsDet, LoadImageFromFileDet,
...
def get_loading_pipeline(pipeline):
    ...
    for cfg in pipeline:
        obj_cls = DET_PIPELINES.get(cfg['type'])
        # TODO：use more elegant way to distinguish loading modules
        if obj_cls is not None and obj_cls in (LoadImageFromFileDet,
                                               LoadAnnotationsDet,
                                               LoadPanopticAnnotations):
