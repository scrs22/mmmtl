...
def update_data_root(cfg, logger=None):
    """Update data root according to env mmmtl_DATASETS.

    If set env mmmtl_DATASETS, update cfg.data_root according to
    mmmtl_DATASETS. Otherwise, using cfg.data_root as default.
    ...
    if 'mmmtl_DATASETS' in os.environ:
        dst_root = os.environ['mmmtl_DATASETS']
        print_log(f'mmmtl_DATASETS has been set to be {dst_root}.'
