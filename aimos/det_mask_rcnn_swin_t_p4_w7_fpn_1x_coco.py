...
def run_main():
    ngpus = 4    
    nodes = 4
    exp_name = 'det_mask_rcnn_swin_t_p4_w7_fpn_1x_coco'
    ...
    src_file = '/gpfs/u/home/AICD/AICDzich/barn/code/multi_learning/aimos/det_mask_rcnn_swin_t_p4_w7_fpn_1x_coco.sh'
