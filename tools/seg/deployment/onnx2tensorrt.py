...
from mmmtl.apis.inference import LoadImage
from mmmtl.datasets import SEG_DATASETS
from mmmtl.datasets.pipelines import ComposeSeg
...
def onnx2tensorrt(onnx_file: str,
    ...
    if verify:
        ...
        if show:
            dataset =SEG_DATASETS.get(dataset)
...
if __name__ == '__main__':
    ...
    assert SEG_DATASETS.get(args.dataset) is not None, \
