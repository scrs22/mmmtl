...
def main():
    ...
    if args.base_lr is not None:
        ...
        cfg.optimizer.lr = args.base_lr / 512.0 * world_size * cfg.data.samples_per_gpu
        print('Set learning rate from ', old_lr, ' to: ', cfg.optimizer.lr)
